...
public class BlinkyChaser extends Chaser {
    ...
    public BlinkyChaser(Ghost ghost, GameState gameState, ConfigsEx configs, AssetRegistry<String, Image> assetRegistry, int[] activePeriodsSec) {
        super(ghost, gameState, configs, assetRegistry, activePeriodsSec, new double[]{configs.GHOST_BLINK_FIRST_FRAME_DISTANCE(), configs.GHOST_BLINK_SECOND_FRAME_DISTANCE()});
    }
